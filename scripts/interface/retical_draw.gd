...
@export var gap_angle : float = 45.0 : set = set_crosshair_angle
@export var segments : int = 2 : set = set_crosshair_segments
...
func set_crosshair_angle(new_gap_angle:float)->void:
