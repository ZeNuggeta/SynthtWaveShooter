...
static func spawn_bullet(ref:Node3D,speed:float)->void:
	var bullet : Bullet
	...
	bullet.speed = speed 
	bullet.global_position = ref.global_position
	bullet.direction = ref.global_transform.basis.z
